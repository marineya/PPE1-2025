...
echo -e "num\turl\thttp_code\tencoding\tmots" > "$FICHIER_TSV"
...
#les explications du code se trouvent sur le journal de bord
#lancer la commande avec chmod +x code_tableau_ok.sh
#excécuter avec ./code_tableau_ok.sh ../urls/fr.txt ../tableaux/tableau_ok.tsv tableau_urls.html
